...
if (!preg_match('/^[a-zA-Z0-9]+$/', $password)) {
    $errors['password'] = "Password must contain only letters and numbers.";
        ...
        $checkUsernameQuery = "SELECT * FROM usersignup WHERE username = '$username'";
        ...
        $checkEmailQuery = "SELECT * FROM usersignup WHERE email = '$email'";
...
<head>
  ...
  <style>
    <?php require("UserRegistration.css")?>
